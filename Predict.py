...
class MainGUI:
    def __init__(self, master):
        ...
        self.semiAutoBtn = Button(self.ctrlPanel, text="Predict", command=self.automate2)
    ...
    def load_image(self, file):
        ...
        if w >= h:
            ...
            print( "Width Percentage:", wpercent)
            ...
            print("Hight Percentage:", wpercent)
            self.img = self.img.resize((wsize, baseH), Image.BICUBIC)

        self.factor = wpercent
        print("Width, Hight", baseW, hsize )
    ...
    def mouse_release(self, event):
        ...
        self.bboxList.append((int(x1 / factor), int(y1 / factor), int(x2 / factor), int(y2 / factor)))  # Resize to original picture
    ...
    def automate2(self):
        ...
        text = labels[y_classes[0]] + str(predictions_my[0, y_classes[0]])
        self.objectListBox.insert(END, text)
